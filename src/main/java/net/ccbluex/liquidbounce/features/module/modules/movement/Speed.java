...
public class Speed extends Module {
    ...
    public final ListValue vulcanModeValue = new ListValue("Vulcan-Mode", new String[]{"GroundSpeed", "LowHopSpeed", "YPortSpeed"}, "Ground", () -> typeValue.get().equalsIgnoreCase("vulcan")) {
